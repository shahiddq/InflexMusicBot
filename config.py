...
LOG_GROUP_ID = int(getenv("-1002179539522", None))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/gojologgg")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/gojologgg")
